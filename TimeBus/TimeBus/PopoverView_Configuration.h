...
#define kGradientTitleBottomColor [UIColor orangeColor]

//top color white value in title gradient bg
#define kGradientTitleTopColor [UIColor orangeColor]


// FONTS

//normal text font
#define kTextFont [UIFont fontWithName:@"Helvetica-Light" size:18]

//normal text color
#define kTextColor [UIColor colorWithRed:0 green:0 blue:0 alpha:1]
...
//title font
#define kTitleFont [UIFont fontWithName:@"Helvetica-Light" size:20]

//title text color
#define kTitleColor [UIColor colorWithRed:255 green:255 blue:255 alpha:1]
